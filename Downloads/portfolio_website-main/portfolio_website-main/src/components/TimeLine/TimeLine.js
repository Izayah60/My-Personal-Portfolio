...
import { BlogCards, Img, CardInfos } from '../Projects/ProjectsStyles';
...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
      I am Isaiah Ikharona<br />Fullstack Web Developer || Blockchain Developer<br />Benin City, Edo State, Nigeria <br /> <br /> Passionate, driven and goal oriented are the best adjectives to describe me. I am a problem solver enriched with fast thinking and creative problem solving abilities. <br /> <br />
